...
void DrawableGameObject::update(float deltaTime) // delta time is the time which has passed since the last frame. This should never be zero. Use it for time based calculations 
{
